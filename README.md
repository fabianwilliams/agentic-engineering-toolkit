...
| [`agents/where-the-kit-fits`](./agents/where-the-kit-fits) | ✅ v1 | Architectural map. Positions the Kit as the **observability control point** that pairs with Cloudflare / AWS Bedrock / Auth0 / Snowflake instead of competing with them. Built on Nate B Jones's 2026-05-20 five-control-point framework. |
